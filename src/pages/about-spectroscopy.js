...
const Container = styled.div`
  .page-section {
    ...
    .page-banner {
      ...
      overflow: hidden;
      object-fit: cover;
      margin-bottom: calc(1rem * var(--spacing-modifier));
    }
      ...
      <Page title="About Spectroscopy">
        <div className="page-section">
          ...
          <p className="lab-description">
            ...
            metabolites, from a region of interest (ROI or voxel). A spectrum of
            peaks is generated whereby each peak is reflective of a chemical
            that resonates at a specific frequency; the height of the peak
            reflects the concentration of that chemical in the brain.
          </p>
        </div>
        <div className="page-section alternate">
          ...
          <div className="metabolite-container">
            ...
            <p className="metabolite-description">
              Lactate is generally seen as a doublet (two peaks close together)
              at a frequency of 1.33 ppm. Again, healthy tissue does not have
              sufficient lactate to be detectable with MRS. However, CSF
              contains some lactate so that if the voxel is placed entirely in
              the ventricle, lactate may appear in the spectrum. Lactate, as a
              product of anaerobic glycolysis, is detected in diseased brain
              when oxygen starved. It is of great diagnostic value in cases of
              hypoxia, brain injury, and stroke. It is also elevated in some
              tumors where it is suggestive of aggressiveness as well as
              abscesses.
            </p>
          </div>
          <div className="metabolite-container">
            ...
            <p className="metabolite-description">
              ...
              neurons, axons, and dendrites27. The diagnostic value of NAA lies
              in the ability to quantify neuronal injury or loss on a regional
              basis and therefore, decreased NAA plays a diagnostic role in
              brain tumors, head injury, dementias, and many other neurological
          ...
          <div className="metabolite-container">
            ...
            <p className="metabolite-description">
              ...
              involved in excitatory neurotransmission lie between 2.1 and
              2.4ppm. Glx is a vital marker(s) in MRS of stroke, lymphoma,
              hypoxia, and many metabolic brain disorders
            </p>
          </div>
          <div className="metabolite-container">
            <h3 className="metabolite-title">Creatine (Cr)</h3>
            <p className="metabolite-description">
              The primary resonance of creatine lies at 3.0ppm. It is the
              central energy marker of both neurons and astrocytes and remains
              relatively constant. For that reason, it is often used as an
              internal reference for comparison to other metabolites. While some
              studies have found Cr reduced, it is only in inborn errors of
              metabolism that significant reductions of Cr occur.
            </p>
          </div>
          <div className="metabolite-container">
            ...
            <p className="metabolite-description">
              ...
              leukodystrophy, multiple sclerosis) result in a massive increase
              in MRS-visible Cho.{" "}
            </p>
          </div>
          <div className="metabolite-container">
            ...
            <p className="metabolite-description">
              ...
              3.6ppm, mI is mostly a diagnostic “modifier” in those diseases
              that affect Cho (tumor, MS, etc). As an astrocyte marker and
              osmolyte, mI contributes specificity in dementia diagnoses106, and
              an almost absolute specificity to hepatic encephalopathy and
              hyponatremic brain syndromes.{" "}
            </p>
          </div>
          <div className="metabolite-container">
